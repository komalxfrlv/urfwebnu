...
<template>
    <section class="services">
        <div>
            <Swiper :height="300" :modules="[SwiperAutoplay, SwiperEffectCreative, SwiperPagination]" :slides-per-view="1"
                :loop="true" :pagination="{ clickable: true }" :effect="'creative'" :autoplay="{
                    delay: 6000,
